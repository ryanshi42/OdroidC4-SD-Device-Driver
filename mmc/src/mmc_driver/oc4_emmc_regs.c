...
result_t oc4_emmc_regs_set_max_data_timeout(oc4_emmc_regs_t *oc4_emmc_regs) {
    ...
    /* Per the oc42835's manual, setting the Data Timeout Unit to 0b1111
...
result_t oc4_emmc_regs_enable_interrupts(
    ...
    result_t res = irpt_en_set_raw32(&oc4_emmc_regs->irpt_en, 0xffffffff);
    if (result_is_err(res)) {
...
result_t oc4_emmc_regs_mask_interrupt(
    ...
    return interrupt_mask_raw32(&oc4_emmc_regs->interrupt, mask, ret_val);
}
...
result_t oc4_emmc_regs_get_interrupt_raw32(
    ...
    return interrupt_get_raw32(&oc4_emmc_regs->interrupt, ret_val);
}
...
result_t oc4_emmc_regs_set_interrupt_raw32(
    ...
    return interrupt_set_raw32(&oc4_emmc_regs->interrupt, val);
}
...
result_t oc4_emmc_regs_is_cmd_timeout_err(
    ...
    return interrupt_get_cto_err(&oc4_emmc_regs->interrupt, ret_val);
}
...
result_t oc4_emmc_regs_is_data_timeout_err(
    ...
    return interrupt_get_dto_err(&oc4_emmc_regs->interrupt, ret_val);
}
...
result_t oc4_emmc_regs_is_cmd_in_progress(
    ...
    return status_get_cmd_inhibit(&oc4_emmc_regs->status, ret_val);
}
...
result_t oc4_emmc_regs_is_data_in_progress(
    ...
    return status_get_dat_inhibit(&oc4_emmc_regs->status, ret_val);
}
...
result_t oc4_emmc_regs_clear_interrupt(
    ...
    return interrupt_clear(&oc4_emmc_regs->interrupt);
}
...
result_t oc4_emmc_regs_is_read_ready(
    ...
    return status_get_read_transfer(&oc4_emmc_regs->status, ret_val);
}
...
result_t oc4_emmc_regs_is_write_ready(
    ...
    return status_get_write_transfer(&oc4_emmc_regs->status, ret_val);
}
...
result_t oc4_emmc_regs_set_bus_width_4(
    ...
    return control0_set_hctl_dwidth(&oc4_emmc_regs->control0, val);
}
